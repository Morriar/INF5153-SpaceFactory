...
import inf5153.spacefactory.ships.HeavyShip;
import inf5153.spacefactory.ships.LightShip;
import inf5153.spacefactory.ships.Ship;
import inf5153.spacefactory.weapons.Weapon;

public class ShipFactory implements SpaceFactory {

    @Override
    public Ship getShip(String model, String id) {
        switch (model) {
            case "SX-V-Light":
                return new LightShip(id);
            case "SX-V-Heavy":
                return new HeavyShip(id);
            default:
